...
.Ltmp0:
	...
	testb	$1, std.core.builtin.in_panic.5944(%rip)
	je	.LBB0_28
# %bb.1:
...
.LBB0_28:
	...
	movb	$1, std.core.builtin.in_panic.5944(%rip)
.Ltmp8:
...
.LBB0_33:
	...
	movb	$0, std.core.builtin.in_panic.5944(%rip)
...
.Lfunc_end4:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.p2align	4, 0x90                         # -- Begin function std.core.builtin.install_signal_handler.6147
	.type	std.core.builtin.install_signal_handler.6147,@function
std.core.builtin.install_signal_handler.6147: # @std.core.builtin.install_signal_handler.6147
.Lfunc_begin5:
...
.Ltmp68:
.Lfunc_end5:
	.size	std.core.builtin.install_signal_handler.6147, .Lfunc_end5-std.core.builtin.install_signal_handler.6147
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function std.core.builtin.install_signal_handlers.6151
	.type	std.core.builtin.install_signal_handlers.6151,@function
std.core.builtin.install_signal_handlers.6151: # @std.core.builtin.install_signal_handlers.6151
.Lfunc_begin6:
...
.Ltmp69:
	...
	callq	std.core.builtin.install_signal_handler.6147
...
.Ltmp70:
.Lfunc_end6:
	.size	std.core.builtin.install_signal_handlers.6151, .Lfunc_end6-std.core.builtin.install_signal_handlers.6151
	.cfi_endproc
                                        # -- End function
	.type	std.core.builtin.in_panic.5944,@object # @std.core.builtin.in_panic.5944
	.local	std.core.builtin.in_panic.5944
	.comm	std.core.builtin.in_panic.5944,1,1
...
.func.23:
	...
	.p2align	3, 0x0
	.quad	std.core.builtin.install_signal_handlers.6151
...
.Ldebug_info_start0:
	...
	.byte	3
	.quad	std.core.builtin.in_panic.5944
...
.Linfo_string5:
	.asciz	"std.core.builtin.in_panic.5944" # string offset=99
.Linfo_string6:
...
.Linfo_string49:
	.asciz	"std.core.builtin.install_signal_handler.6147" # string offset=676
.Linfo_string50:
	.asciz	"install_signal_handler"        # string offset=721
.Linfo_string51:
	.asciz	"std.core.builtin.install_signal_handlers.6151" # string offset=744
.Linfo_string52:
