...
# %bb.2:
	...
	movq	-8(%rbp), %rax
	leaq	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461(%rip), %rcx
	cmpq	%rcx, 16(%rax)
	sete	%al
	movb	%al, -65(%rbp)                  # 1-byte Spill
.LBB4_3:
...
# %bb.6:
	...
	leaq	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461(%rip), %rax
	cmpq	%rcx, %rax
	jne	.LBB5_8
# %bb.7:
.Ltmp36:
...
$ct.std_collections_list$std.os.backtrace.Backtrace$.List:
	...
	.type	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461,@object # @"std_collections_list$std.os.backtrace.Backtrace$.dummy.29461"
	.local	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461
	.comm	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461,4,4
...
.Ldebug_info_start0:
	...
	.byte	3
	.quad	std_collections_list$std.os.backtrace.Backtrace$.dummy.29461
...
.Linfo_string5:
	.asciz	"std_collections_list$std.os.backtrace.Backtrace$.dummy.29461" # string offset=99
.Linfo_string6:
